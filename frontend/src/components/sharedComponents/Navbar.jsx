...
const Navbar = ({}) => {
        ...
        <div className="hidden lg:flex items-center justify-end lg:flex-1 lg:w-0">
          <button
            ...
            className="whitespace-nowrap text-base font-medium
             hover:bg-tkh-brand-tangerine-5 text-tkh-brand-tangerine-3 
             hover:text-tkh-grayscale-0 border-solid border-tkh-grayscale-4 border-2  
          ...
          <NavLink to="/user_registration">
            <button
              href="#"
              className="ml-4 whitespace-nowrap bg-tkh-brand-tangerine-5 px-[20px] h-[36px] 
              rounded border-2 border-solid  border-tkh-brand-tangerine-5 shadow-sm text-base font-medium text-tkh-grayscale-0 
              hover:bg-tkh-grayscale-0 active:bg-tkh-brand-tangerine-5 hover:text-tkh-brand-tangerine-5 "
            >
              Sign Up
            </button>
          </NavLink>
  ...
  return (
    <header className="h-[76px] bg-[#fff] sticky top-0  w-[100vw] z-40">
      <UserBanner/>
      <Popover >
        <div className="flex h-[76px] justify-between items-center mx-auto px-4 py-2 sm:px-6 lg:justify-start md:space-x-10 md:px-6 lg:px-10 xl:px-20 2xl:px-20 ">
          ...
          <div className="-mr-2 -my-1 lg:hidden">
            <Popover.Button className="bg-tkh-brand-tangerine-4 rounded-md p-2 inline-flex items-center justify-center text-tkh-grayscale-0 hover:text-gray-500 hover:bg-gray-100 focus:outline-none">
              ...
              <MenuIcon className="h-6 w-6 text-tkh-grayscale-0" aria-hidden="true" />
            </Popover.Button>
          </div>
      ...
      <div className="w-full h-[30px] flex justify-center items-center bg-tkh-brand-tangerine-5">
        <h2 className="text-[#fff] font-bold">Staging</h2>
      </div>
    </header>
  );
};
