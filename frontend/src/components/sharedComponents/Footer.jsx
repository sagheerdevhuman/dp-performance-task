...
function Footer() {
  ...
  return (
    ...
    <div  className="flex flex-col justify-start  gap-10 py-20 w-full h-[299px]  bg-center bg-no-repeat bg-cover bg-[url(https://d1yh21d3dzz97r.cloudfront.net/Bronx%20Digital%20Pipeline%201.png)]">
      <div className="flex flex-col justify-start gap-7 px-2 2xl:px-0 text-center ">
        <h1 className=" text-4xl xl:text-5xl font-bold">
          Ready to Get Started? 
        </h1>
        {/* <h3 className="text-lg xl:text-xl 2xl:text-2xl font-light text-tkh-grayscale-7 text-center">
        Don't Want to Miss Anything?
        </h3> */}
      </div>
      <div className="flex flex-col xl:flex-row gap-10 h-12 justify-center items-center">
        <button onClick={(e) => navigate("/sign_up")} type="button" className="h-full w-[122px] bg-tkh-brand-tangerine-5 rounded-md text-tkh-grayscale-0">
        Register
        </button>
      </div>
    </div>
    <footer className="bg-tkh-brand-black-1 pb-8">
      <div className="flex flex-col justify-center items-center mt-8  pt-8 max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        ...
        <img className="mb-3 mt-8  w-auto" src="https://d1yh21d3dzz97r.cloudfront.net/1A.Full.%202.png" />
