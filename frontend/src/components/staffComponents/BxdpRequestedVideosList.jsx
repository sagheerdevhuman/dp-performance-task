...
function RequestedVideosList({approved,rejected,videos,setVideos,meta,reload,archived, handleRejectFormRendering, setRejectData, rejectData, selectedVideo, setSelectedVideo, editVideoModalRendered, isEditVideoModalRendered,handleEditVideoFormRendering } ) {
      ...
      {videos.map((video) => (
        ...
        >
          ...
          <td  className="whitespace-nowrap h-8 px-3 pr-3 text-sm font-light text-tkh-grayscale-10">
            <a className="hover:underline hover:text-tkh-brand-tangerine-5" onClick={(e) => handleEditVideoFormRendering(e, video)} >Edit</a> / <a className="hover:underline hover:text-tkh-brand-tangerine-5" onClick={(e) => handleConfirmRendering(e,video)}>Delete</a>
          </td>
          {/* <td>
