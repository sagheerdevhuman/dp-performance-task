  ...
  return (
    <>
      <div className=" flex flex-col mb-3  text-center md:text-left">
        <h1 className="text-4xl font-bold">Member Application:</h1>
      ...
      <p className="m-2 text-sm text-tkh-grayscale-5">Each file should be smaller than 64 MB</p>
       <FileUploader setFile={setLogoImage} errors={errors}
          setErrors={setErrors} type={"logoImage"}/>
          { errors.logoImage && <span style={{color: 'red'}}>Logo Image is required</span>}
      </label>
      <label className="flex flex-col text-tkh-grayscale-7 w-3/4 py-2">
      Banner Image *
      <p className="m-2 text-sm text-tkh-grayscale-5">Each file should be smaller than 64 MB</p>
       <FileUploader setFile={setBannerImage} errors={errors}
          setErrors={setErrors} type={"bannerImage"} />
          {errors.bannerImage && <span style={{color: 'red'}}>Banner Image is required</span>}
      </label>
