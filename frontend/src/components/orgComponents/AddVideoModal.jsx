      ...
      />
        <div className="flex flex-col max-w-[500px] w-[80vw] p-[24px]  drop-shadow-card rounded-[15px] bg-[#fff] ">
          <div className="flex flex-row justify-between items-center mb-[24px]">
            <h1 className="text-[14px] font-[700] text-tkh-brand-tangerine-5 ">Upload Video</h1>
            ...
            <label className="flex flex-col mb-3 font-bold">  
              ...
              <div className="flex flex-col">
                <div>
                  ...
                  <FileUploader setFile={setImage} errors={videoErrors}
                    setErrors={setVideoErrors} type={"image"}/>
                </div>
                <img
                  src={image}
                  alt="{Preview_Image}"
