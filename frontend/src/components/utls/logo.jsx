...
import { Edit } from "./edit/logo";

export const Logo = ({ handleSubmit,image,formData,setFormData,admin}) => {
  ...
  if (edit==true){
    return(
      <form  onSubmit={(e) => handleSubmit(e,formData)} >
        <Edit handleClick={handleClick} image={image} formData={formData} setFormData={setFormData}/>
      </form>
    )
  }
  return (
