...
export const Delete = ({ handleDelete,data,title,text,btn_text }) => {
  ...
  return (
    ...
    <button onClick={(e) => handleConfirmRendering(e)}>
      <Confirm 
        ...
        data={data}
      />
      < svg className=" transition ease-in-out duration-300 " width="26" height="26" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" >
