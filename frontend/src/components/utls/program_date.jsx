...
import { Edit } from "./edit/date/program";




export const ProgramDate = ({admin,handleSubmit,program,formData,setFormData,days,setDays,noTitle}) => {
  ...
  if (edit==true){
    return(
      <form className="w-[579px] mt-5 mb-[50px]" onSubmit={(e) => handleClick(handleSubmit(e,formData))} >
         <Edit 
  ...
  return (
    <div className="flex gap-3 items-center my-5">
      ...
      />*/}
      {admin==true &&(
        <svg className="fill-tkh-grayscale-9 mt-1 h-[24px] min-w-[24px] w-[5%] hover:fill-tkh-brand-tangerine-5 transition ease-in-out duration-300 mr-3" viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg"  onClick={(e) => { handleClick(e);}}>
