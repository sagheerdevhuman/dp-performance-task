...
export const Edit = ({formData, image,setImage, handleSubmit, setFormData,handleClick }) => {
  ...
  return (
    ...
    <div className="flex items-top gap-3">
     ...
     <div className=" rounded-xl h-[40vh] w-[100vw] md:w-full "
          style={{"background":link,"backgroundRepeat":"no-repeat","backgroundPosition":"center","backgroundSize":"cover" }}
      /> 
    </>
  );
};
