...
import { createTopic } from "../../../redux/programs/newTopicSlice";

export const Edit = ({ handleClick, program_id,edit, list, setList ,setOptions,handleSkillFormRendering }) => {
  ...
  if (edit == true){
    return(
      <label className="flex flex-col mb-3">
        ...
        <button
          onClick={(e)=>{handleSkillFormSubmit(e)}}
