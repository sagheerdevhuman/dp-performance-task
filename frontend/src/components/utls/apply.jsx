import { Apply } from "../sharedComponents/Apply";
import { useNavigate } from "react-router-dom";
import { useState, useEffect } from "react";
import { Confirm } from "./confirm";
import { Edit } from "./edit/apply";

export const Apply_link = ({ handleSubmit,  formData, setFormData, program,admin }) => {
  ...
  if (edit==true){
    return(
      <form className="w-[579px]" onSubmit={(e) => handleSubmit(e,formData)} >
        <Edit handleClick={handleClick} formData={formData} setFormData={setFormData} program={program} />
      </form>
    )
  }
